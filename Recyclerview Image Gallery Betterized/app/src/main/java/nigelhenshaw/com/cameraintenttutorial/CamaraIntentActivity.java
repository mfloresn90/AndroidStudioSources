...
public class CamaraIntentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.Adapter imageAdapter = new ImageAdapter(sortFilesToLastest(mGalleryFolder));
    ...
    protected void onActivityResult (int requestCode, int resultCode, Intent data) {
        if(requestCode == ACTIVITY_START_CAMERA_APP && resultCode == RESULT_OK) {
            ...
            // mPhotoCapturedImageView.setImageBitmap(photoCapturedBitmap);
            // setReducedImageSize();
            RecyclerView.Adapter newImageAdapter = new ImageAdapter(sortFilesToLastest(mGalleryFolder));
    ...
    private File[] sortFilesToLastest(File fileImagesDir) {
