 ...
 *
 */
public class AnotherObject extends ARObject {


	public AnotherObject(String name, String patternName,
	...
	public final void draw(GL10 gl) {
	    ...
	    //draw cube
	    //gl.glColor4f(2, 1.1f, 2, 1.1f);
        gl.glColor4x(10, 20, 10, 1);
        gl.glTranslatef( 0.0f, 1.0f, 12.5f );
